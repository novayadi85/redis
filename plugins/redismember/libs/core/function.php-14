...
function wpb_sender_email( $original_email_address ) {
    return 'info@rediscovermelbourne.com.au';
}
...
function mail_success($to , $type = "admin" , $addOns = false){
	add_filter( 'wp_mail_from', 'wpb_sender_email' );
	add_filter( 'wp_mail_from_name', 'wpb_sender_name' );
	...
	if($type =="admin"){
		...
		<p>You have a new business added under ".$current_user->user_login." account to the Re Discover Melbourne website.</p>

		<p>Please review the following information:<br>
		<ol>
			<li>- Business Name: ".$title."</li>
			<li>- Package type: (Free, Advantage, Featured, Customised)</li>
		...
		<p>Thanks for registering in Re Discover Melbourne.
		Please verify your account by clicking the following link:</p>
