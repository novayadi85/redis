					...
					<div class="step step1 row packages" data-step="1" <?php if($is_configured): echo "style=\"display:none;\""; endif;?>>
						...
						<div class="col-md-3"  style="font-size:11.5px">
							<div class="well">
								...
								<h5 class="choose_pricing btn btn-primary" data-package="77" data-value="6 Months">$269.00 / 6 months</h5>
								<h5 class="choose_pricing btn btn-primary" data-package="77" data-value="12 Months">$489.00 / 1 Year</h5>
								<h5 class="choose_pricing btn btn-primary" data-package="77" data-value="24 Months">$895.00 / 2 Years</h3>
								<hr>
								</div>
						</div>
						<div class="col-md-3"  style="font-size:11.5px">
							<div class="well">
								...
								<h5 class="choose_pricing btn btn-primary" data-package="58" data-value="6 Months">$399.00 / 6 months</h5>
								<h5 class="choose_pricing btn btn-primary" data-package="58" data-value="12 Months">$585.00 / 1 Year</h5>
								<h5 class="choose_pricing btn btn-primary" data-package="58" data-value="24 Months">$995.00 / 2 Years</h3>
								<hr>
